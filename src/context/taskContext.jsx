...
export default function ProviderTask({ children }) {
    ...
    const [numOfTasks, setNumOTasks] = useState(0);
    ...
    const shared = { addTaskToProject, addTaskToList, tasks, addTasksListToProject, deleteTaskById, changeStatus, editTask ,addNote, numOfTasks, setNumOTasks}
